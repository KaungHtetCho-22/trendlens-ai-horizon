	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'neumorph-inset-dark': 'inset 2px 2px 5px #1a1a1a, inset -2px -2px 5px #2c2c2c',
			},
			keyframes: {
				'accordion-down': {
					from: { height: '0' },
				...
				'pulse-light': {
					'0%, 100%': { boxShadow: '0 0 0 0 rgba(0, 169, 199, 0.4)' },
					'50%': { boxShadow: '0 0 0 8px rgba(0, 169, 199, 0)' },
				},
				'lens-animation': {
			...
			animation: {
				...
				'lens-animation': 'lens-animation 15s infinite alternate',
			},
			backdropFilter: {
				'none': 'none',
				'blur': 'blur(20px)',
